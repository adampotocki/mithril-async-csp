...
var entries$3 = _core.Array.entries;

var entries$1 = createCommonjsModule(function (module) {
module.exports = { "default": entries$3, __esModule: true };
});
...
$export$4($export$4.S + $export$4.F * !(USE_NATIVE && _iterDetect(function(iter){
...
var getPrototypeOf$4 = _core.Object.getPrototypeOf;

var getPrototypeOf$2 = createCommonjsModule(function (module) {
module.exports = { "default": getPrototypeOf$4, __esModule: true };
});
...
var getOwnPropertyDescriptor$3 = function getOwnPropertyDescriptor$3(it, key){
  return $Object$1.getOwnPropertyDescriptor(it, key);
};

var getOwnPropertyDescriptor$1 = createCommonjsModule(function (module) {
module.exports = { "default": getOwnPropertyDescriptor$3, __esModule: true };
});
...
var _getPrototypeOf = getPrototypeOf$2;

var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);

var _getOwnPropertyDescriptor = getOwnPropertyDescriptor$1;

var _getOwnPropertyDescriptor2 = _interopRequireDefault(_getOwnPropertyDescriptor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = function get$2(object, property, receiver) {
...
var toStringTag$2 = _wksExt.f('toStringTag');

var toStringTag = createCommonjsModule(function (module) {
module.exports = { "default": toStringTag$2, __esModule: true };
});
...
var _dataStructures = dataStructures;
                ...
                for (var _iterator4 = (0, _getIterator3.default)((0, _entries2.default)(parent.pipeline)), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    try {
                        for (var _iterator5 = (0, _getIterator3.default)(channels), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            ...
                            if (pipe === ch2) parent.pipeline.splice(index$$1, 1);
                        }
                    } catch (err) {
...
var Channel = unwrapExports(channel);
...
var ComplexActions = {
  dbInsert: function dbInsert(updateChannels, newWord) {
    ...
    return _asyncToGenerator$1(regeneratorRuntime.mark(function _callee() {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return updateChannels.loading.put(true);
            ...
            case 4:
              _context.next = 6;
              return updateChannels.add.put(newWord);

            case 6:
              _context.next = 8;
              return updateChannels.loading.put(false);
...
var initUpdates = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(app) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            Object.keys(app.updates.consumers).map(function () {
              var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(k) {
                var updateFn, ch, value;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        updateFn = app.updates.consumers[k];
                        ch = app.updates.channels[k];
                      ...
                      case 5:
                        ...
                        _context.next = 10;
                        return app.renderCh.put(app.state);
  ...
  return function initUpdates(_x) {
    return _ref.apply(this, arguments);
  };
}();

var initComplexActions = function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(app) {
    var _this2 = this;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            Object.keys(app.complexActions.consumers).map(function () {
              var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(k) {
                var complexActionFn, ch, value;
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        complexActionFn = app.complexActions.consumers[k];
                        ch = app.complexActions.channels[k];
  ...
  return function initComplexActions(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

var initRender = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(app, element) {
    var _this3 = this;
                  ...
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 2:
                      ...
                      window.requestAnimationFrame(function () {
                        return finishRender.put({});
                      });
                      _context5.next = 8;
                      return finishRender.take();
  ...
  return function initRender(_x5, _x6) {
